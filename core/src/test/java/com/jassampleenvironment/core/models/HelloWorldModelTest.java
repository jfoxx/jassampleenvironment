 ...
 */
package com.jassampleenvironment.core.models;
...
import com.jassampleenvironment.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "jassampleenvironment/components/helloworld");
